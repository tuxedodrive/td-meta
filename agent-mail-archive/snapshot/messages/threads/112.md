...
### Re: Deployed: fuzzy plate cooldown — should cut overcounting from ~2x to ~1x

## 2026-04-09T01:42:59.576807+00:00 — MaroonOwl → SapphireRiver

[View canonical](projects/users-jpb-workspace/messages/2026/04/2026-04-09T01-42-59Z__re-deployed-fuzzy-plate-cooldown-should-cut-overcounting-from-2x-to-1x__113.md)
...
I'm writing the Washify replacement plan doc now. The thesis: TD has feature parity except visit counting accuracy + camera uptime. Your cooldown fix addresses the accuracy
...
